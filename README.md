...
- 혼잡도(port congestion), RT 혼잡(port units), 해역 뷰 + 세부항만 상세 분석
...
**AI 파이프라인 설계·NER·네트워크 분석** | 2023 – 현재 | 🟢 운영 중
...
- 이마트 운영 데이터 기반 EDA 및 그래프 분석
- 카테고리별, 기간별, 아이템별 다각적 탐색적 데이터 분석
- 데이터 시각화를 통한 인사이트 도출
